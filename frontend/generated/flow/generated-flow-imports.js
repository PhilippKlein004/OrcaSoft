...
import $cssFromFile_1 from 'Frontend/styles/views/bewerbung-view.css?inline';

injectGlobalCss($cssFromFile_1.toString(), 'CSSImport end', document);
import $cssFromFile_2 from 'Frontend/styles/views/input-fields.css?inline';

injectGlobalCss($cssFromFile_2.toString(), 'CSSImport end', document);
import $cssFromFile_3 from 'Frontend/styles/views/login-view.css?inline';

injectGlobalCss($cssFromFile_3.toString(), 'CSSImport end', document);
import $cssFromFile_4 from 'Frontend/styles/views/profile-view.css?inline';

injectGlobalCss($cssFromFile_4.toString(), 'CSSImport end', document);
import $cssFromFile_5 from 'Frontend/styles/views/registration-view.css?inline';

injectGlobalCss($cssFromFile_5.toString(), 'CSSImport end', document);
import $cssFromFile_6 from 'Frontend/styles/views/search-view.css?inline';

injectGlobalCss($cssFromFile_6.toString(), 'CSSImport end', document);
import $cssFromFile_7 from 'Frontend/styles/views/stellenangebot-view.css?inline';
